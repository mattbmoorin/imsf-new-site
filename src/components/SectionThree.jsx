      ...
      <div className="hero-next">
        <div className="hero-inner">
          ...
          <h2>
            ...
            (drums). Andres Forero, the drummer for the hit Broadway show
            Hamilton, made a short presentation and conducted a charity auction,
            including two tickets to Hamilton! Click here to read a wonderful
            review of the concert from Jim Motavalli under “Jazz at the
            Synagogue.”
          </h2>
        </div>
      </div>
